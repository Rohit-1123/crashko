...
const RISK_CONFIG: Record<string, { color: string; glow: string; bg: string; border: string }> = {
  "High Risk": { color: "#f87171", glow: "rgba(239,68,68,0.5)",   bg: "rgba(239,68,68,0.1)",  border: "rgba(239,68,68,0.25)"   },
  "At Risk":   { color: "#fbbf24", glow: "rgba(251,191,36,0.5)",  bg: "rgba(251,191,36,0.1)", border: "rgba(251,191,36,0.25)"  },
  Safe:        { color: "#34d399", glow: "rgba(16,185,129,0.5)",  bg: "rgba(16,185,129,0.1)", border: "rgba(16,185,129,0.25)"  },
};
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-white">{fmtDate(log.createdAt)}</p>
                        ...
                        <div className="hidden shrink-0 gap-5 sm:flex">
                          ...
                          <Metric label="Crash"  value={`${log.crashProbability}%`} />
                        </div>
                          ...
                          >
                            ...
                            >
                              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                                <DetailItem label="Sleep"         value={`${log.sleepHours} hrs`} />
                                <DetailItem label="Study"         value={`${log.studyHours} hrs`} />
                                <DetailItem label="Stress"        value={`${log.stressLevel} / 10`} />
                                <DetailItem label="Tasks"         value={String(log.tasksPending)} />
                                <DetailItem label="Deadlines"     value={String(log.deadlinesSoon)} />
                                <DetailItem label="Crash %"       value={`${log.crashProbability}%`} />
                                <DetailItem label="Focus Block"   value={`${log.focusMode} min`} />
                                <DetailItem label="Burnout Score" value={`${log.burnoutScore} / 100`} />
                              </div>
